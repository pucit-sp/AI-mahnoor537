...
bool goal(int a[3][3])
{
	if (a[0][0] == 1 && a[0][1] == 8 && a[0][2] == 7 && a[1][2] == 6 && a[2][2] == 5 && a[2][1] == 4 && a[2][0] == 3 && a[1][0] == 2 && a[1][1]==0)
		{
...
bool IDDFS(int a[3][3], int bound)
{
...
int main()
{
	int puzzle[3][3] = { {0,1,7},{2,8,6},{3,4,5} };
	int depth;
	cout<<"Enter Depth Bound:";
	cin>>depth;
	g=depth;
	bool flag = IDDFS(puzzle, depth );
	if (flag == true)
		cout << "solved!\n";
